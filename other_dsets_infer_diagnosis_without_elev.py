...
# "N" -> "none", meaning no elevation information is used.
# This script is only for inference without elevation information.
ELEVATION_TYPE = "N"
...
with experiment.test():
    ...
    for _, inputs, labels, _, _ in dloaders["test"]:
